def call(String project, String directoryOfMetaInfo, String directoryOfBuild, String branchName, String buildNumber){
    ...
    sh "s3cmd --rexclude='${directoryOfBuild}/build/lib.linux-x86_64-3.6/datatable/*' --acl-public sync ${directoryOfBuild}/build/lib.linux-x86_64-3.6/ s3://ai.h2o.tests/intermittent_files/${branchName}/${buildNumber}/"
